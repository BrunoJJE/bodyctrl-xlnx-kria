...
tflite_model_file = "pose_landmark_full__pinto_float32.tflite"
...
#######################################################################
## In this section, we download an image we want to classify.
################################################################################
#from PIL import Image
#
...
if len(sys.argv) < 2:
    raise ValueError("No DPU target specified. Please run with 'python3 compile_tflite.py `DPU_TARGET`'"\
...
# PARTITION & BUILD
# 
# Use TVM Module pass to annotate and partition Relay graph for Vitis-AI acceleration.
# Targets can be 'DPUCADF8H', 'DPUCZDX8G-zcu104', 'DPUCZDX8G-zcu102'
